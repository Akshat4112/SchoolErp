    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li><a href="<?= site_url('faculties/dashboard');?>">Faculties</a></li>
                <li><a href="<?= site_url('faculties/dashboard');?>">Dashboard</a></li>
                <li><a href="<?= site_url('faculties/subject_reg');?>">Subject Registration</a></li>
                <li><a href="<?= site_url('faculties/stu_badges');?>">Student Badges</a></li>
