            ...
            <div class="col-md-12">
                <div class="form-group">
                    <div class="col-lg-12 col-lg-offset-1">
                        <a href="<?= site_url('admissions/done')?>"> <button type="reset" class="btn btn-primary">Done</button></a>
                        ...
                        <button type="submit" class="btn btn-success">Application Gethering</button>
                        <button type="submit" class="btn btn-success">Admission Process</button>
